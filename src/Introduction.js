            ...
            <div className="Intro">
                <div className="row">
                    <div className="col-8">
                        ...
                        <p>After a diagnosis of cancer, or a chronic condition such as Crohn's disease or Ulcerative Colitis, it can be hard to think about going away on holiday. However, going on holiday can be a positive experience helping you to relax and spend time with family and friends. The Happy Travel Guide is here to show that travel is possible, it might just need a bit more planning beforehand!</p>
